...
1. Download `LanPilot-Setup-0.1.3.exe` and `SHA256SUMS.txt` from the [v0.1.3 preview release](https://github.com/aliteleb/LanPilot/releases/tag/v0.1.3). Read its validation limitations before testing. The separate sources-and-licenses archive is not needed to install.
