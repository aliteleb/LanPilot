...
- Recovery steps are independent. ARP restoration, capture shutdown, application queue shutdown, Firewall removal and QoS removal are checked separately; failed recovery is reported as partial, not success.
